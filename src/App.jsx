...
function App() {
  ...
  return (
    <TodoState >
    <div className=' flex items-center justify-center bg-slate-100 min-h-screen w-full pb-2 font-[poppins]'>
      <div className=' flex flex-col items-center p-2 sm:p-4 md:p-10 bg-white shadow-inner w-fit'>
        <div 
